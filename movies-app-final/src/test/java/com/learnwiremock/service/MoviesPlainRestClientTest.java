...
public class MoviesPlainRestClientTest {
    ...
    void addNewMovie() {
        ...
        Movie toyStory = new Movie(null, "Toy Story 4", batmanBeginsCrew,2019, LocalDate.of(2019, 06, 20));
    ...
    void addNewMovie_InvlaidInput() {
        //given
        String batmanBeginsCrew = "Tom Hanks, Tim Allen";
        Movie toyStory = new Movie(null, null, null, null, LocalDate.of(2019, 06, 20));

        //when
        Assertions.assertThrows(MovieErrorResponse.class, () -> moviesRestClient.addMovie(toyStory));
    ...
    void updateMovie() {
        ...
        Movie darkNightRises = new Movie(null, null, darkNightRisesCrew, null, null);
        Integer movieId = 3;
    ...
    void updateMovie_Not_Found() {
        //given
        String darkNightRisesCrew = "Tom Hardy";
        Movie darkNightRises = new Movie(null, null, null, null, null);
        Integer movieId = 100;
    ...
    void deleteMovie() {
        ...
        //given
        String batmanBeginsCrew = "Tom Hanks, Tim Allen";
        Movie toyStory = new Movie(null, "Toy Story 4", "Tom Hanks, Tim Allen", 2019, LocalDate.of(2019, 06, 20));
        Movie movie = moviesRestClient.addMovie(toyStory);
        Integer movieId=movie.getMovie_id().intValue();

        //when
        String response = moviesRestClient.deleteMovie(movieId);
